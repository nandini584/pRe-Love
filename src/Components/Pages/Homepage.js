...
const HomePage=()=>{
    return(
        ...
        {/* first 2 images */}
        <div className="flex">
            <div className="flex items-center flex-col justify-center w-[calc(50%-5px)] h-[688px] bg1 text-white mr-0 font-Montserrat text-[4.8rem]">
                    <h3>pRe Loved Fashion</h3>
                    <h6 className="text-[3.2rem]">fashion in a loop</h6>
                    <button className="border-2 border-white w-[286px] h-[80px] text-[3.2rem] font-sans rounded-[7px] mt-[70px]">Shop Now</button>
            </div>
            <div className="flex items-center flex-col  justify-center w-[calc(50%-5px)] h-[688px] bg2 text-white font-Montserrat text-[4.8rem]" >
                    <h3>Eco Fashion</h3>
                    <h6 className="text-[3.2rem]">fashion for the planet</h6>
                    <button className="border-2 border-white w-[286px] h-[80px] text-[3.2rem] font-sans rounded-[7px] mt-[70px]">Coming Soon</button>
        ...
        <div className="flex items-center flex-col ">
            ...
            <div className="grid gap-[3vw] text-center text-[3.2rem] font-Montserrat m-auto text-[#666666] mb-[60px] w-fit max-w-[50vw]" style={{
                gridTemplateColumns:"33% 33% 33%",
                gridTemplateRows:"40vh 40px"
            }}> 
        ...
        <div className="w-[100%] h-[400px] bg-[#B4C7A8] flex flex-col text-center font-Montserrat text-white text-[3.2rem] mb-[70px]">
            <h2 className="text-[6.4rem] mb-[70px]">Why pRe Love</h2>
        ...
        <div className="border-4 border-[#B4C7A8] p-[50px] text-center mx-[50px] rounded-[51px]">
            <h3 className="text-[14rem] mb-[10px]">About Us</h3>
            <p className="font-Montserrat text-[2.6rem] text-[#666666]">We are a passionate group of people set on a journey to redesign the sustainable fashion industry and make it affordable. This is our way of giving back to the planet. We realize that the current fashion industry needs a necessary makeover and are determined to fix this to offer a happier experience not only to buyers but also to sellers.</p>
            <p className="font-Montserrat text-[2.6rem] text-[#464646] font-[800]"> We believe that “Creating a sustainable fashion industry isn't just about changing the materials we use or how we produce, it's about changing the way we think about fashion and its impact on our planet.”</p>
        </div>
        </div>
        {/* Testimonials */}
        ...
        <div className="flex justify-around font-Montserrat text-[#666666] gap-[10px] text-[2rem] mb-[100px] mr-[10px] ml-[10px]">
        ...
        <header className="text-center mb-[100px] text-[3.2rem] font-Montserrat text-[#666666]"> Hear from our customers</header>
            ...
            <div className="w-[523px] h-[400px] text-[2rem] text-[#666666] p-[50px]"  style={{
